...
function WhyJoinCard({ icon, title, description }) {
  ...
  return (
    <div ref={ref}className={`bg-gray-800 p-6 rounded-lg shadow-lg transform transition-transform hover:scale-105 bg-gradient-to-br from-gray-800 via-red-950 to-black ${
...
export default function WhyJoin() {
  ...
  return (
    <section className="w-full max-w-6xl mt-12 hover:cursor-pointer">
      <h2 className="text-white font-bold text-4xl mb-4 text-center">Why Join Us</h2>
